...
PROGRAM_NAME := heterogeneity.exe
...
CFLAGS := -march=$(ARCH) -O3 -fomit-frame-pointer -mfpmath=both -m64 -std=c++11 -g -fopenmp
...
PhysiCell_pugixml.o PhysiCell_settings.o PhysiCell_pathology_SVG.o
